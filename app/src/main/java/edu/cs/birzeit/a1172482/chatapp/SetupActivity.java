...
public class SetupActivity extends AppCompatActivity {
    ...
    private void SaveData() {
        ...
        if (username.isEmpty() || username.length() < 3) {
            showError(inputUsername, "Username is not vaild");
        } else if (city.isEmpty() || city.length() < 3) {
            showError(inputUsername, "City is not vaild");
        } else if (country.isEmpty() || country.length() < 3) {
            showError(inputUsername, "Country is not vaild");
        } else if (profession.isEmpty() || profession.length() < 3) {
            showError(inputUsername, "Profession is not vaild");
